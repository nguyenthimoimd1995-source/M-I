...
<div class="main-header">
    ...
    <p>Tác giả: NGUYỄN THỊ MỚI - Trường PTDTBT Tiểu học MẬU LONG - ĐT: 0387787995</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - NGUYỄN THỊ MỚI - Trường PTDTBT Tiểu học MẬU LONG - ĐT: 0387787995</div>", unsafe_allow_html=True)
